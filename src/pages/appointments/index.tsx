            ...
            <IonCardContent>
              ...
              <IonList> 
                <IonItem>
                  ...
                  <IonLabel>{getDateTime(appointment.bookedDateTime).split(" ")[0] + ' ' + getDateTime(appointment.bookedDateTime).split(" ")[1]}</IonLabel>
                </IonItem>
                <IonItem>
                <IonIcon slot="start" />
                  <IonLabel>{getDateTime(appointment.bookedDateTime).split(" ")[2]}</IonLabel>
                </IonItem>
              </IonList>
            </IonCardContent>
          </IonCard>
